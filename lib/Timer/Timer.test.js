...
describe('Timer', () => {
  ...
  describe('getElapsedTime', () => {
    ...
    it('Should return 0 when resetTimer has been called on a new timer', () => {
      const timer = new Timer()
    ...
    it('Should return 0 when resetTimer has been called on a running timer', () => {
      const timer = new Timer()
  ...
  describe('resetTimer', () => {
    it('Should clear associated interval', () => {
      ...
      expect(timer.intervalId).not.toBe(intervalId)
      expect(timer.startTime).toBe(undefined)
      expect(timer.endTime).toBe(undefined)
    })
  })
})
